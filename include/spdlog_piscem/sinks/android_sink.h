...
#    if !defined(SPDLOG_PISCEM_ANDROID_RETRIES)
#        define SPDLOG_PISCEM_ANDROID_RETRIES 2
#    endif
...
protected:
    void sink_it_(const details::log_msg &msg) override
    {
        ...
        int retry_count = 0;
        while ((ret == -11 /*EAGAIN*/) && (retry_count < SPDLOG_PISCEM_ANDROID_RETRIES))
        {
...
private:
    ...
    static android_LogPriority convert_to_android_(spdlog_piscem::level::level_enum level)
    {
        switch (level)
        {
        case spdlog_piscem::level::trace:
            return ANDROID_LOG_VERBOSE;
        case spdlog_piscem::level::debug:
            return ANDROID_LOG_DEBUG;
        case spdlog_piscem::level::info:
            return ANDROID_LOG_INFO;
        case spdlog_piscem::level::warn:
            return ANDROID_LOG_WARN;
        case spdlog_piscem::level::err:
            return ANDROID_LOG_ERROR;
        case spdlog_piscem::level::critical:
