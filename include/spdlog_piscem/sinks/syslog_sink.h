...
public:
    syslog_sink(std::string ident, int syslog_option, int syslog_facility, bool enable_formatting)
        ...
        , syslog_levels_{{/* spdlog_piscem::level::trace      */ LOG_DEBUG,
              /* spdlog_piscem::level::debug      */ LOG_DEBUG,
              /* spdlog_piscem::level::info       */ LOG_INFO,
              /* spdlog_piscem::level::warn       */ LOG_WARNING,
              /* spdlog_piscem::level::err        */ LOG_ERR,
              /* spdlog_piscem::level::critical   */ LOG_CRIT,
              /* spdlog_piscem::level::off        */ LOG_INFO}}
